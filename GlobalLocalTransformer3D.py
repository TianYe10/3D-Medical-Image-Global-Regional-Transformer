...
class GlobalLocalBrainAge(nn.Module):
    def __init__(self,inplace,
        ...
        self.gloout = nn.Linear(out_hidden_size,2) # canbe changed to a MLP
        self.locout = nn.Linear(out_hidden_size,2) # canbe changed to a MLP
    ...
    def forward(self,xinput):
        ...
        glo = self.gloout(xgfeat) # single layer MLP
        outlist=[glo]
